...
public partial class SubtitleExtractorPage : Page
{
    private readonly SubtitleExtractorViewModel _viewModel;

    public SubtitleExtractorPage(SubtitleExtractorViewModel viewModel)
    {
